...
import 'package:credit_card_slider/app/utils/utils.dart';
import 'package:credit_card_slider/app/utils/utils.dart';
import 'package:credit_card_slider/app/utils/utils.dart';
...
class CreditCardViewView extends BaseGetWidget<CreditCardViewController> {
  @override
  String appBarTitle() => "CreditCardViewView";
...
class _CardSliderState extends State<CardSlider> {
  double positionY_line1 = 0;
  double positionY_line2 = 0;
  double _middleAreaHeight = 0;
  double _outsideCardInterval = 0;
  ...
  void initState() {
    ...
    positionY_line2 = positionY_line1 + 220;
  ...
  _updateCardsPosition(double offsetY) {
    void updatePosition(CardInfo cardInfo, double firstCardAtAreaIdx, int cardIdx) {
      ...
      printData("1:   $currentCardAtAtreaIdx   $firstCardAtAreaIdx   $cardIdx");
      ...
      } else if (currentCardAtAtreaIdx >= 1 && currentCardAtAtreaIdx <= _cardInfoList.length) {
